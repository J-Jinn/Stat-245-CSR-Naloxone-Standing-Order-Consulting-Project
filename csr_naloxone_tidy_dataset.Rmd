---
title: "CSR Naloxone Standing Order Project - Data Cleaning, Wrangling, and Exploration (eventually)"
...
```{r}
vssr <- read_csv("datasets//deprecated//VSRR_Provisional_Drug_Overdose_Death_Counts.csv")
```
...
```{r}
agg1 <- read_csv("datasets//deprecated//Underlying_Cause_of_Death_1999-2018.csv")
```
...
```{r}
agg2 <- read_csv("datasets//deprecated//Underlying_Cause_of_Death_1999-2018_2.csv")
```
...
```{r}
agg3 <- read_csv("datasets//joseph_jinn_queries//deprecated//CDC_GROUPBY_County_Gender_2012_2018_DrugAlcoholCauses.csv")
```
...
```{r}
agg4 <- read_csv("datasets//joseph_jinn_queries//deprecated//CDC_GROUPBY_County_Race_2012_2018_DrugAlcoholCauses.csv")
```
...
```{r}
read.table(file = "datasets//joseph_jinn_queries//deprecated//Underlying Cause of Death, 1999-2018 3.txt",
           header = TRUE,
           sep = "\t"
           )
```
