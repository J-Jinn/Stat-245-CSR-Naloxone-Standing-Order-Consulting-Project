...
**Lines 762-965 in the RMD is the negative binomial model for the first research question.**
...
**Lines 1076-1339 in the RMD is the logistic regression model I attempted to fit for the 3rd research question.  This one has severe issues.**

**Feel free to ignore everything else until I manage to re-factor everything into version 2 of the draft model.**

**Note: Had to re-tidy and re-clean the data.  Also did simple EDA and made prediction plots.  Feel free to ignore those sections and the immediate section below.**
